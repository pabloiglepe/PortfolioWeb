...
export const i18n = {
    ...
    'view_experience': { es: 'Trayectoria Profesional', en: 'Professional Experience' },
    ...
    'role_tag': { es: 'Futuro Técnico Superior en DAW. Con experiencia en proyectos tanto académicos como profesionales utilizando tecnologías Full-Stack. Destaco por mi compromiso, mi habilidad para el trabajo en equipo y la resolución de problemas.', en: 'Future Senior Technician in Web Application Development. Experienced in both academic and professional projects using full-stack technologies. I excel in commitment, teamwork, and problem-solving.' },
    ...
    'download_cv_text': { es: 'CV en formato PDF:', en: 'CV in PDF format:' },
